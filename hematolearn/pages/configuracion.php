...
// Configuración es accesible siempre, pero muestra datos de usuario si hay sesión
?>
<!DOCTYPE html>
<html lang="es">
<head>
    ...
    <title>HematoLearn | Configuración</title>
...
<br>Registro</a>
        ...
        <main class="contenido">
            <div style="margin-bottom:1rem;">
                ...
                <p class="page-subtitulo">Personaliza tu experiencia en HematoLearn</p>
            </div>

            <?php if ($usuario): ?>
            <div class="config-section">
                <h2>👤 Tu cuenta</h2>
                <div class="config-row"><label>Nombre</label><strong><?= htmlspecialchars($usuario['nombre']) ?></strong></div>
                <div class="config-row"><label>Correo</label><strong><?= htmlspecialchars($usuario['email']) ?></strong></div>
                <div class="config-row">
                    <label>Cambiar contraseña</label>
                    <a href="#" class="btn btn-secundario" style="font-size:0.78rem; padding:0.35rem 0.8rem;">Cambiar</a>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="config-section">
                ...
                <div class="config-row">
                    ...
                    <div style="display:flex; gap:0.5rem;">
                        <button class="btn btn-primario" style="font-size:0.78rem; padding:0.3rem 0.8rem;">☀️ Claro</button>
                        <button class="btn btn-secundario" style="font-size:0.78rem; padding:0.3rem 0.8rem;">🌙 Oscuro</button>
                    </div>
                </div>
                <div class="config-row">
                    <label>Idioma</label>
                    <select style="padding:0.4rem 0.7rem; border:1.5px solid var(--gris-borde); border-radius:var(--radio); font-size:0.82rem; background:var(--gris-fondo);">
            ...
            <div class="config-section">
                ...
                <div class="config-row">
                    <label>Nuevos exámenes disponibles</label>
                    <label class="toggle"><input type="checkbox" checked><span class="toggle-slider"></span></label>
                </div>
            </div>
            ...
            <div class="config-section">
                <h2>ℹ️ Acerca de</h2>
                <div class="config-row"><label>Versión</label><strong>5.0.0</strong></div>
                <div class="config-row"><label>Actualizado</label><strong>Mayo 2026</strong></div>
            </div>
        </main>
    </div>
</body>
